...
import com.aurum.whitehole.rendering.object.ShapeRenderer;
import com.aurum.whitehole.rendering.object.AreaRenderer;
import com.aurum.whitehole.rendering.object.*;
    ...
    public static GLRenderer substituteRenderer(AbstractObj obj, GLRenderer.RenderInfo info) {
        try {
            ...
            if (obj.getClass() == ChangeObj.class)
                return new ColorCubeRenderer (100f, new Color4(1f, 1f, 1f), new Color4(0.4f,0.6f,0.7f), true);
        }
