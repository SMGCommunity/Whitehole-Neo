...
public class CutsceneObj extends AbstractObj {
    public CutsceneObj(ZoneArchive zone, String filepath, BcsvFile.Entry entry) {
        this.type = "cutscene";
        this.zone = zone;
    ...
    public CutsceneObj(ZoneArchive zone, String filepath, int game, String objname, Vector3 pos) {
        this.zone = zone;
        String[] stuff = filepath.split("/");
        directory = stuff[0];
        layer = stuff[1].toLowerCase();
    ...
    public void getProperties(PropertyGrid panel) {
        ...
        panel.addCategory("obj_cutscenes", "Cutscene");
