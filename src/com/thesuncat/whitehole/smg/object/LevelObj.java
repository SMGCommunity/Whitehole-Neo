...
public class LevelObj extends AbstractObj {
    public LevelObj(ZoneArchive zone, String filepath, BcsvFile.Entry entry) {
        this.type = "general";
        this.zone = zone;
    ...
    public void getProperties(PropertyGrid panel) {
        ...
        panel.addField("ShapeModelNo", getFieldName("ShapeModelNo"), "int", null, data.get("ShapeModelNo"), "Default");
        if (ZoneArchive.game == 2)
            panel.addField("ParamScale", getFieldName("ParamScale"), "float", null, data.get("ParamScale"), "Default");
