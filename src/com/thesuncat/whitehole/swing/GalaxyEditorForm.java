...
public class GalaxyEditorForm extends javax.swing.JFrame {
    ...
    /**
     * Called when worlmap object selection is changed. No idea what it does. TODO
     */
    ...
    {//GEN-HEADEREND:event_formWindowClosing
        ...
        if(unsavedChanges) {
            ...
            if(res == JOptionPane.CANCEL_OPTION)
                return;//setDefaultCloseOperation(WindowConstants.DO_NOTHING_ON_CLOSE);
            else {
    ...
    public void generateCameraFromView() throws FileNotFoundException, IOException {
        ...
        // for some reason two identical rows are genned, delet one // not anymore, wtp
    ...
    public LinkedHashMap<Integer, WorldmapPoint> worldMapPickingList = new LinkedHashMap<>();
    ...
    private void initDarkTheme() {
        ...
        subArray.addAll(Arrays.asList(itemClose, itemControls, itemPosition, itemPositionPaste, itemRotation, itemRotationPaste,
                itemSave, itemScale, itemScalePaste));
    ...
    private void initJapanese() {
        ...
        mnuEdit.setText("編集");
            subCopy.setText("コピー");
                itemPosition.setText("位置");
                itemRotation.setText("回転");
                itemScale.setText("倍率");
