...
public class BcsvEditorForm extends javax.swing.JFrame
{
    ...
    private void bcsvOpen() {
        ...
        {
            JOptionPane.showMessageDialog(this, "Can't open BCSV file: "+ ex.getMessage(), Whitehole.fullName, JOptionPane.ERROR_MESSAGE);
            try
            {
                if (bcsv != null) bcsv.close();
                if (archive != null) archive.close();
    ...
    private void btnExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportActionPerformed
        if (tblBcsv.getColumnCount() == 0) {
            JOptionPane.showMessageDialog(null, "No BCSV file opened.", Whitehole.fullName, JOptionPane.OK_CANCEL_OPTION);
        }
        else {
            bcsvExport();
        }
