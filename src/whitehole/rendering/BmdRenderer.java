...
import whitehole.rendering.cache.ShaderCache;
import whitehole.rendering.cache.TextureCache;
...
public class BmdRenderer extends GLRenderer {
    ...
    protected final void ctor_loadModel(String modelname) throws GLException {
        ...
        try {
            ...
            container = new RarcFile(Whitehole.getCurrentGameFileSystem().openFile(filepath));
