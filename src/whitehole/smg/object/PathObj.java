...
public class PathObj {
    ...
    private ColorCubeRenderer bigPointRenderer, smallPointRenderer;
    ...
    public ColorCubeRenderer getBigPointRenderer() {
        return bigPointRenderer;
    }
    
    public ColorCubeRenderer getSmallPointRenderer() {
    ...
    private void initColorAndCubeRenderers() {
        ...
        bigPointRenderer = new ColorCubeRenderer(100.0f, new Color4(1f, 1f, 1f, 1f), color, false);
        smallPointRenderer = new ColorCubeRenderer(50.0f, new Color4(1f, 1f, 1f, 1f), color, false);
    }
